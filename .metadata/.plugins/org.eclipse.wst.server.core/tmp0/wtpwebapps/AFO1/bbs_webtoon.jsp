...
<body>
	...
	<div class= "container">
	    	<div= "row">
	    	    <table class= "table table-stripped" style= "text-align: center; boarder: 1px solid #dddddd">
	    	    	...
	    	    	<tbody>
	    	    		<tr>
	    	    			<%
	    	    				BbsDAO bbsDAO = new BbsDAO(); // 웹툰 데이터만 가져오도록 해야함.
	    	    				ArrayList<Bbs> list = bbsDAO.getList_webtoon(pageNumber); // list는 현재의 pageNumber에서 가져온 게시글 리스트가 된다.
	 ...
	 <!-- 제목을 누를 때는 해당 게시글의 내용을 보여주는 페이지로 넘어가야 하기에 view.jsp페이지로 해당 게시글 번호를 bbsID변수로 보내줌. 그래서 <a>태그안에 있음 -->   
	    	    ...
	    	    %>
	    	    <a href= "write_webtoon.jsp" class="btn btn-primary" style="color : #F4FFFF;" > 토론방 생성 </a>
	    	</div>
	</div>
